...
class GUI:
    ...
    def display_name_section(self):
        ...
        self.join_button = Button(frame, text="Join", width=10, font="Helvetica 10 bold", bg="#ABB2B9", command=self.on_join).pack(side='left',padx=(10, 0))
        self.exit_button = Button(frame, text="Exit", width=10, font="Helvetica 10 bold", bg="#ABB2B9", command=self.on_close_window).pack(side='left',padx=(10, 10))
